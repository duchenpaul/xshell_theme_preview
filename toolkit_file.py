...
def text_replace_in_file(pattern, string, file):
    ...
    with open(file) as f:
        replaced_script = re.sub(
            pattern, string, f.read(), flags=re.IGNORECASE)
...
if __name__ == '__main__':
    print([i for i in get_file_list(
        r'C:\Users\chdu\Desktop\Portal\Other\xshell_theme_preview\Xshell-ColorScheme-lib') if not i.lower().endswith('.xcs')])
